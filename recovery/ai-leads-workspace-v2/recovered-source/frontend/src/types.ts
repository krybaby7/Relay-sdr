...
export interface Segment { id: string; call_id: string; seq: number; role: string; text: string; start_ms: number | null; end_ms: number | null; active: boolean; redacted: boolean; supersedes: string | null; received_at: string }
